...
def _compute_x_from_totals(values: pd.Series) -> int:
    """
    Compute thematic x-index using CRR >= 1.
    """
...
def _thematic_x_index(
    ...
    *,
    ...
    """
    Compute literature-defined thematic x-index.
    """
...
def x_index(
    ...
    *,
    ...
    Auto mode:
    - If keyword column exists -> thematic x-index
    - Else -> citation-profile x metric fallback
    """
